...
export async function runFebecosAgent(input: {
  ...
  const response = await getOpenAI().responses.create({
    ...
    instructions: [
      ...
      "SIEMPRE que des una cotizacion o recomiendes un modelo, inclui en el MISMO mensaje el link de la ficha del catalogo: https://selector.febecos.com/catalogo-v2/{result.sugerencia.url_slug} (o construilo por potencia+diametro: kit-bomba-solar-{diametro}-{watts}w). Frase: 'Podes ver todos los datos de este equipo online aca: {link}'. Es obligatorio incluir el link junto con el precio.",
      ...
      "Si el cliente pide algo puntual nombrando una potencia o modelo (ej '500W', 'kit full de 500'), pasale el link de la ficha del catalogo donde ve precio: https://selector.febecos.com/catalogo-v2/kit-bomba-solar-{diametro}-{watts}w (diametro en pulgadas 2/3/4). Si hay selectorQuote, usa result.sugerencia.url_slug como slug exacto: https://selector.febecos.com/catalogo-v2/{url_slug}. Pasalo asi: 'Aca podes ver todo el detalle del equipo: {link}'. Despues de pasar el link, ofrece revisar juntos con los 4 datos (profundidad, altura tanque, diametro perforacion, uso/litros). No inventes el precio en el texto: vive en la ficha.",
