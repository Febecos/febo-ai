...
export async function runFebecosAgent(input: {
  ...
  const response = await getOpenAI().responses.create({
    ...
    instructions: [
      ...
      "Si el cliente pide algo puntual nombrando una potencia o modelo (ej '500W', 'kit full de 500'), pasale el link de la ficha del catalogo donde ve precio: https://selector.febecos.com/catalogo/kit-bomba-solar-{diametro}-{watts}w (diametro en pulgadas 2/3/4). Si hay selectorQuote, usa result.sugerencia.url_slug como slug exacto: https://selector.febecos.com/catalogo/{url_slug}. Despues de pasar el link, ofrece revisar juntos con los 4 datos (profundidad, altura tanque, diametro perforacion, uso/litros). No inventes el precio en el texto: vive en la ficha.",
