...
- 2026-05-19: Ajuste de concision post-cotizacion: `6 cuotas o contado` ahora muestra tambien `Hablar asesor`. Si el cliente responde solo `6 cuotas`, `seis cuotas` o `contado`, FEBO.AI confirma en una frase y no repite la cotizacion completa.
